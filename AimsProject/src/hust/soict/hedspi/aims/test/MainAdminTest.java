package AimsProject.src.hust.soict.hedspi.aims.test;
...
public class MainAdminTest {
    public static void main(String[] args) {
        ...
        DigitalVideoDisc dvd4 = new DigitalVideoDisc("Harry Potter and the Goblet of Fire", "Adventure", "Mike Newell",
                157, 4.5f);
        ...
        CompactDisc cd1 = new CompactDisc(4, "Fetch the Bolt Cutters", "Alternative", 10.39f, "Unknown", "Fiona Apple");
